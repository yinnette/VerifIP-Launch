...
class TC_header_main {
    ...
    function tc_social_in_header($resp = null) {
        ...
        $class 		=  ('resp' == $resp) ? '':'span12' 
        ?>

        	<div class="social-block <?php echo $class ?>">
        		<div class="login-links"><a href="/demo" target="_blank"><span class="glyphicon glyphicon-comment"></span> Chat with Us</a><a href="https://secure.verifip.com/sign_in" target="_blank"><span class="glyphicon glyphicon-user"></span> Login Portal</a></div>
